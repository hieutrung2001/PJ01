...
using PJ01.Core.ViewModels.Responses.Accounts;
...
namespace PJ01.WebAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(IConfiguration config, SignInManager<User> signInManager, ITokenService tokenService, IAccountService accountService)
        {
            _config = config;
